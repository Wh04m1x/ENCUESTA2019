			...
			if ($row10['estado'] == 'Publico') {
			 	for ($i = 1; $i <= 100; $i++) {
					...
					if (isset($_POST[$i])) {
						...
						$query2 = "SELECT id_opcion, id_pregunta, valor, nivel FROM opciones WHERE id_opcion = '$ids[$i]'";
						...
						/////////////////////////////////////////////////////////////////////
							$query3 = "INSERT INTO resultados (id_opcion, valor, area, nivel, pregunta) 
							VALUES ('$id_opcion', '$valor','$area', '$nivel', '$id_pregunta')";
